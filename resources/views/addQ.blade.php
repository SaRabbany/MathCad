                    ...
                    <form class="row g-3" action="{{ url('/store') }}" method="post">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="validationDefaultUsername" name="name" aria-describedby="inputGroupPrepend2" placeholder="Username">
                            </div>
                            @error('name')
                        ...
                        <div class="col-md-12">
                            ...
                            <input placeholder="Your Title" name="title" type="text" class="form-control" id="validationDefault01">
                        </div>
                        @error('title')
                            <span class="text-danger" >{{ $message }}</span>                            
                        @enderror
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea placeholder="Place your description here." name="description" class="form-control" id="validationDefault03" rows="5"></textarea>
                        ...
                        <div class="col-12">
                            <input class="btn common-button" type="submit" Value="submit">
                        </div>
                    </form>
                </div>
            </section>
